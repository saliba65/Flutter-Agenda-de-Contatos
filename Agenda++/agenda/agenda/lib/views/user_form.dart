...
class UserForm extends StatelessWidget {
  ...
  void _loadFormData(User user) {
    if (user != null) {
      ...
      _formData['aniversario'] = user.aniversario;
    }
  }
                  ...
                  if (isValid) {
                    ...
                    Provider.of<Users>(context, listen: false).put(
                      User(
                        ...
                        aniversario: _formData['aniversario'],
                        cep: _formData['cep'],
          ...
          child: Form(
            ...
            child: Column(
              children: <Widget>[
                ...
                TextFormField(
                  initialValue: _formData['aniversario'],
                  decoration: InputDecoration(labelText: 'Data de Aniversario'),
                  onSaved: (value) => _formData['aniversario'] = value,
                ),
                TextFormField(
